...
class Ui_CalcyOption(object):
    def setupUi(self, CalcyOption):
        ...
        self.spinboxOutputPrecision.setMaximumSize(QtCore.QSize(60, 20))
        self.spinboxOutputPrecision.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.spinboxOutputPrecision.setMinimum(0)
        self.spinboxOutputPrecision.setMaximum(71)
        self.spinboxOutputPrecision.setProperty("value", 2)
        ...
        self.checkBoxZeroTreshold = QtWidgets.QCheckBox(self.tabOutput)
        self.checkBoxZeroTreshold.setChecked(False)
        self.checkBoxZeroTreshold.setObjectName("checkBoxZeroTreshold")
        self.horizontalLayout_4.addWidget(self.checkBoxZeroTreshold)
        self.spinBoxZeroTreshold = QtWidgets.QSpinBox(self.tabOutput)
        self.spinBoxZeroTreshold.setMinimumSize(QtCore.QSize(55, 0))
        self.spinBoxZeroTreshold.setMaximumSize(QtCore.QSize(60, 20))
        self.spinBoxZeroTreshold.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.spinBoxZeroTreshold.setSuffix("")
        self.spinBoxZeroTreshold.setMinimum(-200)
        self.spinBoxZeroTreshold.setMaximum(-10)
        self.spinBoxZeroTreshold.setSingleStep(1)
        self.spinBoxZeroTreshold.setProperty("value", -15)
        self.spinBoxZeroTreshold.setObjectName("spinBoxZeroTreshold")
        self.horizontalLayout_4.addWidget(self.spinBoxZeroTreshold)
        ...
        self.checkBoxUseEnterKey = QtWidgets.QCheckBox(self.tabOutput)
        self.checkBoxUseEnterKey.setChecked(True)
        self.checkBoxUseEnterKey.setObjectName("checkBoxUseEnterKey")
        self.verticalLayout_4.addWidget(self.checkBoxUseEnterKey)
        ...
        self.checkBoxDecOut = QtWidgets.QCheckBox(self.groupBox_3)
        self.checkBoxDecOut.setChecked(True)
        self.checkBoxDecOut.setObjectName("checkBoxDecOut")
        self.horizontalLayout.addWidget(self.checkBoxDecOut)
    ...
    def retranslateUi(self, CalcyOption):
        ...
        self.radioButtonDecSepSystem.setToolTip(_translate("CalcyOption", "Use system settings"))
        self.radioButtonDecSepSystem.setText(_translate("CalcyOption", "System default"))
        self.radioButtonDecSepComa.setToolTip(_translate("CalcyOption", "Use coma (\',\')"))
        self.radioButtonDecSepComa.setText(_translate("CalcyOption", "Coma as decimal point and dot as group separator"))
        self.radioButtonDecSepDot.setToolTip(_translate("CalcyOption", "Use dot (\'.\')"))
        self.radioButtonDecSepDot.setText(_translate("CalcyOption", "Dot as decimal point and coma as group separator"))
        self.label.setText(_translate("CalcyOption", "Output Precision"))
        self.spinboxOutputPrecision.setToolTip(_translate("CalcyOption", "Sets the maximal number of digits for \"default\" or minimal number of decimals for \"fixed\" and \"scientific\" output formats."))
        self.checkBoxZeroTreshold.setToolTip(_translate("CalcyOption", "Enable or disable diplaying small enough numbers as zero."))
        self.checkBoxZeroTreshold.setText(_translate("CalcyOption", "Small numbers as zero"))
        self.spinBoxZeroTreshold.setToolTip(_translate("CalcyOption", "Numbers smaller than this will be displayed as zeroes. "))
        self.spinBoxZeroTreshold.setPrefix(_translate("CalcyOption", "1e"))
        self.checkBoxShowGrpSep.setToolTip(_translate("CalcyOption", "If this option is enabled, pressing enter key will copy calculation result to clipboard."))
        self.checkBoxShowGrpSep.setText(_translate("CalcyOption", "Show group separator in result"))
        self.checkBoxUseEnterKey.setToolTip(_translate("CalcyOption", "If this option is enabled, pressing enter key will copy calculation result to clipboard."))
        self.checkBoxUseEnterKey.setText(_translate("CalcyOption", "Use Enter key to Copy result to Clipboard"))
        ...
        self.checkBoxDecOut.setText(_translate("CalcyOption", "Dec"))
        ...
        self.checkBoxShowBasePrefix.setText(_translate("CalcyOption", "Show base prefix in results"))
        self.checkBoxShowLeadingZerosBin.setText(_translate("CalcyOption", "Show leading zeros in bin output"))
        self.checkBoxShowLeadingZerosOct.setText(_translate("CalcyOption", "Show leading zeroes in oct output"))
