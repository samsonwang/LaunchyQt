...
Checkout what feature is in develop at [[https://github.com/samsonwang/LaunchyQt/projects/1][here]] , last commit dev(devlop) branch [[https://github.com/samsonwang/LaunchyQt/tree/dev][file:https://img.shields.io/github/last-commit/samson/LaunchyQt/dev.svg]] .
